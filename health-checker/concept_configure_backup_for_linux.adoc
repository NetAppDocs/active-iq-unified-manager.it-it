...
---
= Configura il backup su Linux in Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Ad esempio, se hai creato un backup su Unified Manager 9.18, il backup può essere ripristinato solo sui sistemi Unified Manager 9.18.
