...
---
= Determina i problemi di spazio negli aggregati usando le API di Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/space_utilization.gif[Diagramma di flusso per identificare i volumi sovrautilizzati con modalità di ridimensionamento automatico abilitata negli aggregati di cluster]
