...
---
= Scopri come Active IQ Unified Manager monitora l'infrastruttura virtuale VMware
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/vm_deployment.gif[Un diagramma che mostra host VMware, VM, datastore, VMDK, rete IP e connessioni di storage]

*Workflow utente*

Il seguente diagramma mostra un tipico caso di utilizzo della vista della topologia della macchina virtuale:

image::../media/vm_workflow.gif[Un diagramma che mostra un flusso di lavoro per individuare la latenza delle applicazioni VM attraverso i livelli di elaborazione, rete e storage]
