...
---
= Aggiungi avvisi in Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Si noti che se si aggiunge una Storage Virtual Machine (SVM) o un cluster alle risorse di un avviso, gli oggetti figlio non vengono aggiunti automaticamente. Ad esempio, se si aggiunge un cluster alle risorse di un avviso, l'avviso non aggiunge automaticamente i nodi o le LUN.
