...
---
= Rimuovi Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Questo passaggio rimuove tutti i pacchetti NetApp RPM associati. Non rimuove i moduli software prerequisiti, come Java, MySQL e 7zip.

. *Facoltativo:* se appropriato, rimuovere i moduli software di supporto, come Java, MySQL e 7zip:
+
