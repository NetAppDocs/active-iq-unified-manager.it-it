...
---
= Comprendi i requisiti di infrastruttura virtuale e hardware per Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Inoltre, esiste un limite al numero di nodi che una singola istanza di Unified Manager può monitorare prima di installare una seconda istanza di Unified Manager. Per i limiti dei nodi, le raccomandazioni relative a CPU e memoria, vedi la  https://www.netapp.com/pdf.html?item=/media/13504-tr4621.pdf["Guida alle Best practice di Unified Manager"^].
