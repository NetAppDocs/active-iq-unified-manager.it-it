...
---
= Scopri i requisiti software e di installazione Linux in Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Unified Manager è distribuito su un server web WildFly. WildFly 27.0.1.Final è incluso e configurato con Unified Manager.
...
* MySQL Community Edition versione 8.4.10 (dal repository MySQL)
* OpenJDK versione 17.0.14+6 (dal repository Red Hat Extra Enterprise Linux Server)
* Python 3.13.3 (dal repository di Red Hat Extra Enterprise Linux Server)
* Versione 7zip 7z2301-linux-x64. Per maggiori informazioni, vedere link:task_configure_7zip_package.html["Configurare il pacchetto software 7-zip"].
