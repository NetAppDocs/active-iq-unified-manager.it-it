...
---
= Aggiorna Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Prima di aggiornare Unified Manager, è necessario installare o aggiornare la versione corretta di 7-zip. Vedere link:task_configure_7zip_package.html["Configurare il pacchetto software 7-zip"].
...
* MySQL Community Edition viene aggiornato automaticamente durante l'aggiornamento di Unified Manager. Se la versione di MySQL installata sul tuo sistema è precedente alla 8.4.10, il processo di aggiornamento di Unified Manager aggiorna automaticamente MySQL alla versione 8.4.10.
