...
[NOTE]
====
Se il tuo sistema è stato aggiornato da Unified Manager 9.7, non puoi eseguire l'upgrade direttamente dalla versione 9.14 alla 9.18 a causa delle modifiche al file system nelle versioni di Debian. Invece, segui questo percorso di upgrade consigliato: 9.14 -> 9.16P2 -> 9.18.
