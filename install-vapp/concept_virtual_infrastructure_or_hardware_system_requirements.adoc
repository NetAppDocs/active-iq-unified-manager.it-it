...
---
= Scopri i requisiti di infrastruttura virtuale e hardware per Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Inoltre, esiste un limite al numero di nodi che una singola istanza di Unified Manager può monitorare prima che tu installi una seconda istanza di Unified Manager. Per i limiti dei nodi, le raccomandazioni su CPU e memoria, vedi link:https://www.netapp.com/pdf.html?item=/media/13504-tr4621.pdf["la Guida alle migliori pratiche di Unified Manager"^].
