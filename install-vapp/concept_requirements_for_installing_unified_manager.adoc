...
---
= Assicurati che il server soddisfi i requisiti di installazione di Active IQ Unified Manager.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Per ulteriori informazioni, vedere https://mysupport.netapp.com/matrix["Tool di matrice di interoperabilità NetApp"]
