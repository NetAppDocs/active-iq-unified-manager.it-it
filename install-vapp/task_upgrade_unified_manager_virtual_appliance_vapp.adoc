...
---
= Aggiorna l'appliance virtuale Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile aggiornare l'appliance virtuale Active IQ Unified Manager dalle versioni 9.14 o 9.16 alla versione 9.18.
