...
---
= Aggiorna OpenJDK su Windows per Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Per scaricare il file è necessario un account Oracle. Se non hai un account Oracle, vai a link:https://signon.oracle.com/signin["la pagina di accesso all'account Oracle"] per crearne uno.
