...
Inoltre, esiste un limite al numero di nodi che una singola istanza di Unified Manager può monitorare prima di installare una seconda istanza di Unified Manager. Per i limiti dei nodi, CPU e raccomandazioni sulla memoria, vedi  https://www.netapp.com/pdf.html?item=/media/13504-tr4621.pdf["la Guida alle migliori pratiche di Unified Manager"^].
