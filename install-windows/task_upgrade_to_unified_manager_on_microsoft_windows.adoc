...
[role="lead"]
È possibile aggiornare Unified Manager 9.11 o 9.12 a 9.13 scaricando ed eseguendo il file di installazione sulla piattaforma Windows.
...
====
* MySQL Community Edition viene aggiornato automaticamente durante l'aggiornamento di Unified Manager. Se la versione installata di MySQL sul sistema è precedente alla 8.0.32, il processo di aggiornamento di Unified Manager aggiorna automaticamente MySQL alla versione 8.0.32. Non è necessario eseguire un aggiornamento standalone di una versione precedente di MySQL alla versione 8.0.32.
