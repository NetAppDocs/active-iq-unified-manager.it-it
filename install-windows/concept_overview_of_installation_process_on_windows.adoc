...
---
= Scopri il processo di installazione di Active IQ Unified Manager su Windows
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/install_flow_on_windows.gif[Un diagramma che mostra i prerequisiti, l'installazione di Unified Manager e i passaggi del flusso di lavoro per la configurazione iniziale]
