...
---
= Scopri gli eventi della piattaforma Active IQ in Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NetApp Active IQ è un servizio basato su cloud che offre analisi predittive e supporto proattivo per ottimizzare le operazioni del sistema storage nel NetApp hybrid cloud. Vedi https://docs.netapp.com/us-en/active-iq/index.html["NetApp Active IQ"^] per ulteriori informazioni.
