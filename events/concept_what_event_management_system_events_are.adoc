...
Nome evento di Unified Manager (convertito dal nome evento EMS)
 a| 
Non specifico nel formato "Error EMS Received" (errore EMS ricevuto). Il messaggio dettagliato fornisce il formato di notazione a punti dell'evento EMS effettivo
