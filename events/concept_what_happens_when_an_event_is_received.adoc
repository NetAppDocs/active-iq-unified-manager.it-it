...
---
= Capisci come Active IQ Unified Manager gestisce un evento ricevuto
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/um_perf_threshold_event_flow.gif[Un diagramma che mostra l'elaborazione degli eventi di soglia dalla raccolta dei dati del contatore alla notifica via email]
