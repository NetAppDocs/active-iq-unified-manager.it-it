...
---
= Aggiungi cluster ad Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Questo account deve avere il ruolo _admin_ con l'accesso all'applicazione impostato su _ontapi_, _amqp_, _console_ e _http_.
