...
---
= Tipi di protezione SnapMirror in Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Per ulteriori informazioni sulla sincronizzazione attiva di SnapMirror, fare riferimento alla link:https://docs.netapp.com/us-en/ontap/smbc/index.html["Documentazione di ONTAP 9 per SnapMirror Active Sync (in precedenza SM-BC)"].
